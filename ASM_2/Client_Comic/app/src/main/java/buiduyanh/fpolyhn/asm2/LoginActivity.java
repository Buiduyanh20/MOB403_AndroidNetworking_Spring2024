...
public class LoginActivity extends AppCompatActivity {
    ...
    {
        try {
            mSocket = IO.socket(MySharedPreferences.URL);
        ...
        btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edt_username.getText().toString().isEmpty() || edt_passwd.getText().toString().isEmpty()) {
                    ...
                    Call<User> call = apiService.getUserLogin(edt_username.getText().toString(), edt_passwd.getText().toString());
    ...
    private void showBottomDialogRegister() {
        ...
        btn_res.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String password = edt_passwd_res.getText().toString();
                String pass_again = edt_passwd_res_again.getText().toString();
                String email = edt_email_res.getText().toString();
                if (username.isEmpty() || fullname.isEmpty() || password.isEmpty() || pass_again.isEmpty() || email.isEmpty()) {
                    Toast.makeText(LoginActivity.this, "Không được để trống thông tin", Toast.LENGTH_SHORT).show();
                } else if (!password.equals(pass_again)) {
